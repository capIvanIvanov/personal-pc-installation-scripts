...
sudo su -c "touch /etc/modprobe.d/blacklist-radeon.conf"
sudo su -c "echo 'blacklist radeon' >> /etc/modprobe.d/blacklist-radeon.conf"
sudo su -c "echo 'options radeon modeset=0' >> /etc/modprobe.d/blacklist-radeon.conf"
...
sudo su -c "echo 'options vfio-pci ids=1002:9443,1002:aa30' >> /etc/modprobe.d/vfio.conf"
